                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                <div class="col-8">
                                    ...
                                    <input type="number" min="0" id="prisonier" name="prisonier" placeholder="10" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-8">
                                    <label for="quantite" class="form-control-label">Quantité (Tonnes)</label>
                                    <input type="text" id="quantite" name="quantite" placeholder="10.1" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-8">
